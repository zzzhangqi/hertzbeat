 ...
 * @date 2022/9/9
 */
@ProtocolType(name = "jdbc")
public class JdbcProtocolImpl implements ProtocolTypeDiptach {
    @Override
    public Map<String, Object> dispatch(Metrics request) {
        JacksonUtil<JdbcProtocol> jacksonUtil = new JacksonUtil<>();
        return jacksonUtil.readValue(request.getJdbc());
    }
}
